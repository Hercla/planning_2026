...
Sub Calculer_Totaux_Planning()
    ...
    Dim ligneFin As Long: ligneFin = GetCfgLong(configGlobal, "ligneFin", 28)
    ...
    Dim ligneNumJour As Long: ligneNumJour = GetCfgLong(configGlobal, "PLN_Row_DayNumbers", 4)
    ...
    Dim couleurBleuClair As Long: couleurBleuClair = GetCfgLong(configGlobal, "COULEUR_BLEU_CLAIR", 15128749)
    ...
    lig(1) = GetCfgLong(configGlobal, "CALC_ROW_Matin", 60)    ' Matin
    lig(2) = GetCfgLong(configGlobal, "CALC_ROW_AM", 61)       ' Apres-midi (AM)
    lig(3) = GetCfgLong(configGlobal, "CALC_ROW_Soir", 62)     ' Soir
    lig(4) = GetCfgLong(configGlobal, "CALC_ROW_Nuit", 0)      ' Nuit (0 si pas defini)
    lig(5) = GetCfgLong(configGlobal, "CALC_ROW_P_0645", 64)   ' Present a 06H45
    lig(6) = GetCfgLong(configGlobal, "CALC_ROW_P_7H8H", 65)   ' Presence entre 7h et 8h
    lig(7) = GetCfgLong(configGlobal, "CALC_ROW_P_8H1630", 66) ' Presence a 16h30
    lig(8) = GetCfgLong(configGlobal, "CALC_ROW_C15", 67)      ' Presence en C 15
    lig(9) = GetCfgLong(configGlobal, "CALC_ROW_C20", 68)      ' Presence en C 20
    lig(10) = GetCfgLong(configGlobal, "CALC_ROW_C20E", 69)    ' Presence en C 20 E
    lig(11) = GetCfgLong(configGlobal, "CALC_ROW_C19", 70)     ' Presence en C 19
    ' --- COCKPIT LAYOUT (zone 60-73) ---
    Dim rDates As Long: rDates = GetCfgLong(configGlobal, "COCKPIT_ROW_DATES", 59)
    Dim rDatesSrc As Long: rDatesSrc = GetCfgLong(configGlobal, "COCKPIT_ROW_DATES_SRC", 3)
    Dim rLabelStart As Long: rLabelStart = GetCfgLong(configGlobal, "COCKPIT_ROW_LABEL_START", 59)
    Dim rLabelEnd As Long: rLabelEnd = GetCfgLong(configGlobal, "COCKPIT_ROW_LABEL_END", 75)
    ...
    Dim rP0645 As Long: rP0645 = GetCfgLong(configGlobal, "COCKPIT_ROW_P0645", 64)
    Dim rP7H8H As Long: rP7H8H = GetCfgLong(configGlobal, "COCKPIT_ROW_P7H8H", 65)
    Dim rP81630 As Long: rP81630 = GetCfgLong(configGlobal, "COCKPIT_ROW_P81630", 66)
    Dim rC15 As Long: rC15 = GetCfgLong(configGlobal, "COCKPIT_ROW_C15", GetCfgLong(configGlobal, "CALC_ROW_C15", 67))
    Dim rC20 As Long: rC20 = GetCfgLong(configGlobal, "COCKPIT_ROW_C20", GetCfgLong(configGlobal, "CALC_ROW_C20", 68))
    Dim rC20E As Long: rC20E = GetCfgLong(configGlobal, "COCKPIT_ROW_C20E", GetCfgLong(configGlobal, "CALC_ROW_C20E", 69))
    Dim rC19 As Long: rC19 = GetCfgLong(configGlobal, "COCKPIT_ROW_C19", GetCfgLong(configGlobal, "CALC_ROW_C19", 70))
    Dim rNuitCode1 As Long: rNuitCode1 = GetCfgLong(configGlobal, "COCKPIT_ROW_NUIT_CODE1", 71)
    Dim rNuitCode2 As Long: rNuitCode2 = GetCfgLong(configGlobal, "COCKPIT_ROW_NUIT_CODE2", 72)
    Dim rNuitTotal As Long: rNuitTotal = GetCfgLong(configGlobal, "COCKPIT_ROW_NUIT_TOTAL", 73)
    Dim rAction As Long: rAction = GetCfgLong(configGlobal, "COCKPIT_ROW_ACTION", 75)

    Dim target78 As Long: target78 = GetCfgLong(configGlobal, "EFF_7H8H", 2)
    ...
    Dim cfgC20ReqSpecial As Long: cfgC20ReqSpecial = GetCfgLong(configGlobal, "COCKPIT_C20_REQUIRED_SPECIAL", 2)
    Dim cfgC20ReqNormal As Long: cfgC20ReqNormal = GetCfgLong(configGlobal, "COCKPIT_C20_REQUIRED_NORMAL", 1)
    Dim cfgC19Req As Long: cfgC19Req = GetCfgLong(configGlobal, "COCKPIT_C19_REQUIRED", 1)
    Dim cfgC15ReqCount As Long: cfgC15ReqCount = GetCfgLong(configGlobal, "COCKPIT_C15_REQUIRED_COUNT", 1)
    Dim cfgCoupeMinTotal As Long: cfgCoupeMinTotal = GetCfgLong(configGlobal, "COCKPIT_COUPES_MIN_TOTAL", 3)
    Dim cfg78MinTotal As Long: cfg78MinTotal = GetCfgLong(configGlobal, "COCKPIT_7H8H_MIN_TOTAL", target78)
    Dim cfg78MinInf As Long: cfg78MinInf = GetCfgLong(configGlobal, "COCKPIT_7H8H_MIN_INF", 2)
    Dim cfg78MinAS As Long: cfg78MinAS = GetCfgLong(configGlobal, "COCKPIT_7H8H_MIN_AS", 1)
    Dim cfg78AllowAllInf As Long: cfg78AllowAllInf = GetCfgLong(configGlobal, "COCKPIT_7H8H_ALLOW_ALL_INF", 1)
    Dim cfgP0645Req As Long: cfgP0645Req = GetCfgLong(configGlobal, "COCKPIT_P0645_REQUIRED", 1)
    Dim cfgCheckFontOk As Long: cfgCheckFontOk = GetCfgLong(configGlobal, "COCKPIT_CHECK_FONT_SIZE_OK", 14)
    Dim cfgCheckFontAlert As Long: cfgCheckFontAlert = GetCfgLong(configGlobal, "COCKPIT_CHECK_FONT_SIZE_ALERT", 9)
    ...
    Dim cfgNuitReqTotal As Long: cfgNuitReqTotal = GetCfgLong(configGlobal, "COCKPIT_NUIT_REQUIRED_TOTAL", 2)
    ...
    Dim cfgLabelFontSize As Long: cfgLabelFontSize = GetCfgLong(configGlobal, "COCKPIT_LABEL_FONT_SIZE", 16)
    Dim cfgLabelFontBold As Long: cfgLabelFontBold = GetCfgLong(configGlobal, "COCKPIT_LABEL_FONT_BOLD", 0)
    ...
    effSem(1) = GetCfgLong(configGlobal, "EFF_SEM_Matin", 7)
    effSem(2) = GetCfgLong(configGlobal, "EFF_SEM_PM", 3)
    effSem(3) = GetCfgLong(configGlobal, "EFF_SEM_Soir", 3)
    effSem(4) = GetCfgLong(configGlobal, "EFF_SEM_Nuit", 2)
    effWE(1) = GetCfgLong(configGlobal, "EFF_WE_Matin", 5)
    effWE(2) = GetCfgLong(configGlobal, "EFF_WE_PM", 2)
    effWE(3) = GetCfgLong(configGlobal, "EFF_WE_Soir", 3)
    effWE(4) = GetCfgLong(configGlobal, "EFF_WE_Nuit", 2)
    effFER(1) = GetCfgLong(configGlobal, "EFF_FER_Matin", 5)
    effFER(2) = GetCfgLong(configGlobal, "EFF_FER_PM", 2)
    effFER(3) = GetCfgLong(configGlobal, "EFF_FER_Soir", 3)
    effFER(4) = GetCfgLong(configGlobal, "EFF_FER_Nuit", 2)
    
    ' Seuil minimum INF
    Dim seuilMinINF As Long: seuilMinINF = GetCfgLong(configGlobal, "ALERT_SEUIL_MIN_INF", 2)
    
    ' Annee pour calcul feries
    Dim annee As Long: annee = GetCfgLong(configGlobal, "CFG_Year", Year(Date))
