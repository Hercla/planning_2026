...
Public Sub GenererDatesEtJoursPourTousLesMois()
    ...
    ' Lire configuration
    '========================
    FIRST_DAY_COL = CLng(Module_Config.CfgValueOr("PLN_FirstDayCol", 0))
    LAST_DAY_COL = CLng(Module_Config.CfgValueOr("PLN_LastDayCol", 0))
    ROW_JOUR_SEMAINE = CLng(Module_Config.CfgValueOr("PLN_Row_DayNames", 0))
    ROW_NUMERO_JOUR = CLng(Module_Config.CfgValueOr("PLN_Row_DayNumbers", 0))
    
    annee = CLng(Module_Config.CfgValueOr("CFG_Year", 0))
    ...
    colorWeekend = CLng(Module_Config.CfgValueOr("PLN_Couleur_Weekend", 15773696))
    colorFerie = CLng(Module_Config.CfgValueOr("PLN_Couleur_Ferie", 255))
    colorPoliceWE = CLng(Module_Config.CfgValueOr("PLN_Couleur_Police_Weekend", 16777215))
    colorPoliceFerie = CLng(Module_Config.CfgValueOr("PLN_Couleur_Police_Ferie", 16777215))
