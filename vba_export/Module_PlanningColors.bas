...
Public Sub LoadPlanningColors()
    ...
    m_ColorWeekend = CLng(Module_Config.CfgValueOr("PLN_Couleur_Weekend", 15773696))    ' Bleu clair
    m_ColorFerie = CLng(Module_Config.CfgValueOr("PLN_Couleur_Ferie", 255))             ' Rouge
    m_ColorPoliceWE = CLng(Module_Config.CfgValueOr("PLN_Couleur_Police_Weekend", 16777215))  ' Blanc
    m_ColorPoliceFerie = CLng(Module_Config.CfgValueOr("PLN_Couleur_Police_Ferie", 16777215)) ' Blanc
