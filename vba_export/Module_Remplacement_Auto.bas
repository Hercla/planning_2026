...
' =========================================================================
' FONCTIONS UTILITAIRES LOCALES (Non dans Core car sp�cifiques)
' =========================================================================
...
Function CodeDejaPresent(planningArr As Variant, rempArr As Variant, jourCol As Long, ByVal codeToCheck As String, Optional exactMatch As Boolean = False) As Boolean
...
' OPTIMISATION CL� : Lit les effectifs depuis lignes 60-62 (Module_Planning_Core)
' =========================================================================
...
Sub TraiterUneFeuilleDeMois(ws As Worksheet, _
    ...
    ' === CHARGER EFFECTIFS INITIAUX DEPUIS LIGNES 60-62 (OPTIMISATION CL�) ===
    ...
    ' === CHARGER JOURS F�RI�S (utilise Module_Planning_Core) ===
    ...
    For col = 1 To nbJours
        ...
        ' Utilise Module_Planning_Core pour d�tection f�ri�
        ...
        For l = 1 To NB_REMPLACEMENT_JOUR_LIGNES
            If Trim(CStr(rempJourArr(l, col))) = "" Then
                ...
                ' === LOGIQUE SOIR SP�CIFIQUE (VEN/SAM/F�RI�) ===
                ...
                If estJourSpecialSoir And manqueSoir > 0 Then
                    ...
                    ' V�rifier C19 dans remplacements d�j� faits
