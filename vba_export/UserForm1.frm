...
'UserForm5.Show ' D�SACTIV� - form inexistant
End Sub
...
On Error GoTo ErrHandler
    ...
    ' 1) G�n�re jours + num�ros + couleurs sur Janv..Dec
    Call GenerateurCalendrier.GenererDatesEtJoursPourTousLesMois

    ' 2) Met � jour Config_Codes (F/R + heures) selon Feuil_Config!B2
    Call MettreAJourConfigurationCodes

    MsgBox "MAJ DATES termin�e : calendriers + f�ri�s (F/R) + heures codes.", vbInformation
    GoTo CleanExit
...
' On appelle la proc�dure publique et on lui passe le code
...
'place un ast�rix si besoin inf niveau du code
Call ToggleAsterisqueCellule
End Sub

Private Sub CommandButton112_Click()
'met la couleur vert fonc� code hrel
...
'rend visible seulement si elle est vide et que le nombre de lignes visibles est inf�rieur au nombre demand�.
Call AfficherMasquerLignesDynamiques

End Sub

Private Sub CommandButton120_Click()
    ' Afficher le UserForm pour la mise � jour des lignes
    Call MajLigne
End Sub
...
Private Sub CommandButton31_Click()
    ' Call RAZPlanMens  ' D�SACTIV� - proc supprim�e
End Sub
...
Call Mode_Nuit
ActiveWindow.Zoom = 70 'R�glage de zoom
End Sub
...
End Sub
' --- AJOUTEZ CETTE PROC�DURE DANS LE CODE DU USERFORM "Menu" ---
